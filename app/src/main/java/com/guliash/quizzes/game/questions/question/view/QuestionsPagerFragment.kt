...
import com.guliash.quizzes.game.questions.question.presenter.QuestionsPagerPresenter
...
class QuestionsPagerFragment : BaseFragment(), QuestionsPagerView {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.question_pager_fragment, container, false)
    }

    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        (activity as QuestionsGameActivity).gameComponent.inject(this)
