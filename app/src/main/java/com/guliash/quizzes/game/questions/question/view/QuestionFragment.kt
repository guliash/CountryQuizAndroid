...
import com.guliash.quizzes.game.questions.answer.view.createAnswerFragment
import com.guliash.quizzes.game.questions.question.QuestionUtils
...
class QuestionFragment : BaseFragment(), QuestionView, ComponentProvider {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        questionComponent = (activity as QuestionsGameActivity).gameComponent.plus(QuestionModule(whichQuestion))
